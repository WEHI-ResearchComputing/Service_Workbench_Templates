...
# /usr/bin/docker pull 010045907075.dkr.ecr.ap-southeast-2.amazonaws.com/analysisenv:1
...
#   -i -t \
#   --name analysisenv_1 \
#   010045907075.dkr.ecr.ap-southeast-2.amazonaws.com/analysisenv:1

# 3) start the local container by name:
/usr/bin/docker start analysisenv_1
